...
// load the styles
var content = __webpack_require__("b378");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add CSS to Shadow Root
var add = __webpack_require__("35d6").default
module.exports.__inject__ = function (shadowRoot) {
  add("5213d4da", content, shadowRoot)
};
...
"use strict";
/* WEBPACK VAR INJECTION */(function(Buffer) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return HandshakeProtocol; });
/* harmony import */ var _TextMessageFormat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("2183");
/* harmony import */ var _Utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("c9f7");
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
...
var HandshakeProtocol = /** @class */ (function () {
    ...
    HandshakeProtocol.prototype.parseHandshakeResponse = function (data) {
        ...
        var messageData;
        var remainingData;
        if (Object(_Utils__WEBPACK_IMPORTED_MODULE_1__[/* isArrayBuffer */ "f"])(data) || (typeof Buffer !== "undefined" && data instanceof Buffer)) {
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"4614117c-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/App.vue?vue&type=template&id=6b3c95b3&shadow
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[(_vm.shouldCreateGame)?_c('app-game',{attrs:{"playerDetail":_vm.playerObj}}):_vm._e()],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/App.vue?vue&type=template&id=6b3c95b3&shadow
...
// CONCATENATED MODULE: ./node_modules/@aspnet/signalr/dist/esm/Errors.js
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
...
var HttpError = /** @class */ (function (_super) {
    Errors_extends(HttpError, _super);
...
var TimeoutError = /** @class */ (function (_super) {
    Errors_extends(TimeoutError, _super);
...
var AbortError = /** @class */ (function (_super) {
    Errors_extends(AbortError, _super);
...
// CONCATENATED MODULE: ./node_modules/@aspnet/signalr/dist/esm/HttpClient.js
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
var HttpClient_assign = (undefined && undefined.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
...
var HttpClient = /** @class */ (function () {
    ...
    HttpClient.prototype.get = function (url, options) {
        return this.send(HttpClient_assign({}, options, { method: "GET", url: url }));
    };
    HttpClient.prototype.post = function (url, options) {
        return this.send(HttpClient_assign({}, options, { method: "POST", url: url }));
    };
    HttpClient.prototype.delete = function (url, options) {
        return this.send(HttpClient_assign({}, options, { method: "DELETE", url: url }));
    };
...
var ILogger = __webpack_require__("7835");

// CONCATENATED MODULE: ./node_modules/@aspnet/signalr/dist/esm/XhrHttpClient.js
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
...
// CONCATENATED MODULE: ./node_modules/@aspnet/signalr/dist/esm/DefaultHttpClient.js
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
...
// EXTERNAL MODULE: ./node_modules/@aspnet/signalr/dist/esm/HandshakeProtocol.js
var HandshakeProtocol = __webpack_require__("2ced");

// CONCATENATED MODULE: ./node_modules/@aspnet/signalr/dist/esm/IHubProtocol.js
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
...
var Utils = __webpack_require__("c9f7");
...
var HubConnection_HubConnection = /** @class */ (function () {
    ...
    HubConnection.prototype.stream = function (methodName) {
        ...
        var subject = new Utils["c" /* Subject */](function () {
...
// CONCATENATED MODULE: ./node_modules/@aspnet/signalr/dist/esm/ITransport.js
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
...
// CONCATENATED MODULE: ./node_modules/@aspnet/signalr/dist/esm/LongPollingTransport.js
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        if (response.statusCode === 204) {
                            ...
                            if (response.content) {
                                this.logger.log(ILogger["a" /* LogLevel */].Trace, "(LongPolling transport) data received. " + Object(Utils["e" /* getDataDetail */])(response.content, this.logMessageContent) + ".");
                                if (this.onreceive) {
    ...
    LongPollingTransport.prototype.send = function (data) {
        return LongPollingTransport_awaiter(this, void 0, void 0, function () {
            return LongPollingTransport_generator(this, function (_a) {
                ...
                return [2 /*return*/, Object(Utils["g" /* sendMessage */])(this.logger, "LongPolling", this.httpClient, this.url, this.accessTokenFactory, data, this.logMessageContent)];
            });
        });
    };
...
// CONCATENATED MODULE: ./node_modules/@aspnet/signalr/dist/esm/ServerSentEventsTransport.js
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
                    ...
                    case 2: return [2 /*return*/, new Promise(function (resolve, reject) {
                            ...
                            try {
                                eventSource.onmessage = function (e) {
                                    if (_this.onreceive) {
                                        try {
                                            _this.logger.log(ILogger["a" /* LogLevel */].Trace, "(SSE transport) data received. " + Object(Utils["e" /* getDataDetail */])(e.data, _this.logMessageContent) + ".");
    ...
    ServerSentEventsTransport.prototype.send = function (data) {
        return ServerSentEventsTransport_awaiter(this, void 0, void 0, function () {
            return ServerSentEventsTransport_generator(this, function (_a) {
                ...
                return [2 /*return*/, Object(Utils["g" /* sendMessage */])(this.logger, "SSE", this.httpClient, this.url, this.accessTokenFactory, data, this.logMessageContent)];
            });
        });
    };
...
// CONCATENATED MODULE: ./node_modules/@aspnet/signalr/dist/esm/WebSocketTransport.js
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
...
var WebSocketTransport_WebSocketTransport = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 2: return [2 /*return*/, new Promise(function (resolve, reject) {
                            ...
                            webSocket.onmessage = function (message) {
                                _this.logger.log(ILogger["a" /* LogLevel */].Trace, "(WebSockets transport) data received. " + Object(Utils["e" /* getDataDetail */])(message.data, _this.logMessageContent) + ".");
                                if (_this.onreceive) {
    ...
    WebSocketTransport.prototype.send = function (data) {
        if (this.webSocket && this.webSocket.readyState === this.webSocketConstructor.OPEN) {
            this.logger.log(ILogger["a" /* LogLevel */].Trace, "(WebSockets transport) sending data. " + Object(Utils["e" /* getDataDetail */])(data, this.logMessageContent) + ".");
...
// CONCATENATED MODULE: ./node_modules/@aspnet/signalr/dist/esm/HttpConnection.js
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
...
if (typeof window === "undefined" && "function" !== "undefined") {
    // In order to ignore the dynamic require in webpack builds we need to do this magic
    // @ts-ignore: TS doesn't know about these names
    var HttpConnection_requireFunc =  true ? require : undefined;
...
var HttpConnection_HttpConnection = /** @class */ (function () {
    function HttpConnection(url, options) {
        ...
        this.features = {};
        Utils["a" /* Arg */].isRequired(url, "url");
        this.logger = Object(Utils["d" /* createLogger */])(options.logger);
        ...
        return HttpConnection_awaiter(this, void 0, void 0, function () {
            ...
            return HttpConnection_generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 12:
                        e_2 = _a.sent();
                        this.logger.log(ILogger["a" /* LogLevel */].Error, "Failed to start the connection: " + e_2);
                        this.connectionState = 2 /* Disconnected */;
                        this.transport = undefined;
                        throw e_2;
        ...
        return HttpConnection_awaiter(this, void 0, void 0, function () {
            ...
            return HttpConnection_generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        e_3 = _b.sent();
                        this.logger.log(ILogger["a" /* LogLevel */].Error, "Failed to complete negotiation with the server: " + e_3);
                        throw e_3;
                    case 6: return [2 /*return*/];
                }
            });
        ...
        return HttpConnection_awaiter(this, void 0, void 0, function () {
            ...
            return HttpConnection_generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 7:
                        ex_1 = _a.sent();
                        this.logger.log(ILogger["a" /* LogLevel */].Error, "Failed to start the transport '" + HttpTransportType[transport] + "': " + ex_1);
                        this.connectionState = 2 /* Disconnected */;
...
var Loggers = __webpack_require__("7b74");

// EXTERNAL MODULE: ./node_modules/@aspnet/signalr/dist/esm/TextMessageFormat.js
var TextMessageFormat = __webpack_require__("2183");
...
// CONCATENATED MODULE: ./node_modules/@aspnet/signalr/dist/esm/HubConnectionBuilder.js
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
...
var HubConnectionBuilder_HubConnectionBuilder = /** @class */ (function () {
    ...
    HubConnectionBuilder.prototype.build = function () {
        ...
        return HubConnection_HubConnection.create(connection, this.logger || Loggers["a" /* NullLogger */].instance, this.protocol || new JsonHubProtocol_JsonHubProtocol());
    };
...
// CONCATENATED MODULE: ./node_modules/@aspnet/signalr/dist/esm/index.js
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
...
var CONFIG = {
  NODE_ENV: "production",
  HUB_URL: "http://gamehubs.pk.land/tugOfWarHub"
};
var isDevelopmentMode = () => CONFIG.NODE_ENV === 'development';
// CONCATENATED MODULE: ./src/enums/HubAction.ts
var HubAction;

(function (HubAction) {
  HubAction["Join"] = "Join";
  HubAction["Hit"] = "Hit";
  HubAction["NextRound"] = "NextRound";
})(HubAction || (HubAction = {}));
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/ts-loader??ref--13-3!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Game.vue?vue&type=script&lang=ts&
...
var Gamevue_type_script_lang_ts_HelloWorld = class HelloWorld extends external_Vue_default.a {
  constructor() {
    super(...arguments);
  ...
  created() {
    this.player = _objectSpread({}, this.player, this.playerDetail);
    this.connection = new HubConnectionBuilder_HubConnectionBuilder().withUrl(CONFIG.HUB_URL).build();
    ...
    this.connection.on('opponentHit', data => {
    ...
    this.connection.start().then(() => this.connection.invoke(HubAction.Join, this.player.name));
  }
...
__decorate([Prop()], Gamevue_type_script_lang_ts_HelloWorld.prototype, "playerDetail", void 0);

Gamevue_type_script_lang_ts_HelloWorld = __decorate([vue_class_component_common_default.a], Gamevue_type_script_lang_ts_HelloWorld);
/* harmony default export */ var Gamevue_type_script_lang_ts_ = (Gamevue_type_script_lang_ts_HelloWorld);
// CONCATENATED MODULE: ./src/components/Game.vue?vue&type=script&lang=ts&
 /* harmony default export */ var components_Gamevue_type_script_lang_ts_ = (Gamevue_type_script_lang_ts_); 
...
function injectStyles (context) {
  ...
  var style0 = __webpack_require__("6c49")
...
/* harmony default export */ var Game = (component.exports);
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/ts-loader??ref--13-3!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/App.vue?vue&type=script&lang=ts&shadow




var Appvue_type_script_lang_ts_shadow_App = class App extends external_Vue_default.a {
  get playerObj() {
    if (isDevelopmentMode()) {
      return {
        name: `p${Math.floor(Math.random() * 10000)}`
      };
    }
...
__decorate([Prop()], Appvue_type_script_lang_ts_shadow_App.prototype, "player", void 0);

Appvue_type_script_lang_ts_shadow_App = __decorate([vue_class_component_common_default()({
  components: {
    AppGame: Game
  }
...
window.customElements.define('pk-game', vue_wc_wrapper(external_Vue_default.a, Appshadow))
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_0_0_node_modules_css_loader_index_js_ref_8_oneOf_0_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_0_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_0_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_0_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Game_vue_vue_type_style_index_0_lang_scss_module_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("152c");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_0_0_node_modules_css_loader_index_js_ref_8_oneOf_0_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_0_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_0_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_0_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Game_vue_vue_type_style_index_0_lang_scss_module_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_8_oneOf_0_0_node_modules_css_loader_index_js_ref_8_oneOf_0_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_0_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_0_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_0_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Game_vue_vue_type_style_index_0_lang_scss_module_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_8_oneOf_0_0_node_modules_css_loader_index_js_ref_8_oneOf_0_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_0_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_0_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_0_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Game_vue_vue_type_style_index_0_lang_scss_module_true___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_8_oneOf_0_0_node_modules_css_loader_index_js_ref_8_oneOf_0_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_0_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_0_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_0_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Game_vue_vue_type_style_index_0_lang_scss_module_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_vue_style_loader_index_js_ref_8_oneOf_0_0_node_modules_css_loader_index_js_ref_8_oneOf_0_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_0_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_0_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_0_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Game_vue_vue_type_style_index_0_lang_scss_module_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// module
exports.push([module.i, ".Game_game_area_1dyh3{max-width:300px;width:100%;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-ms-flex-line-pack:center;align-content:center;margin:0 auto;text-align:center}.Game_game_area_1dyh3,.Game_hit_area_RjFJW{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}.Game_hit_area_RjFJW{height:30vh;background:bisque;border:1px solid #000}.Game_player_3bGlB{background:#7fffd4}.Game_name_2Qge_{height:10%;text-align:center}.Game_times_1idE8{height:90%;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;font-size:3em}.Game_modal_overlay_3GerV{position:fixed;width:100%;height:100vh;background:rgba(0,0,0,.9);left:0;top:0;z-index:1000}.Game_modal_container_2dt9Z{position:absolute;top:50%;-webkit-transform:translateY(-50%);transform:translateY(-50%);left:0;right:0}.Game_modal_content_2setp{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;width:300px;margin:0 auto}.Game_join_next_rB8pE{height:35px;font-size:1.2em;background:#7fffd4;cursor:pointer;color:#2f4f4f}.Game_result_text_1vqrk{font-size:2em;text-align:center;margin-bottom:50px;color:#7fffd4}", ""]);

// exports
exports.locals = {
	"game_area": "Game_game_area_1dyh3",
	"hit_area": "Game_hit_area_RjFJW",
	"player": "Game_player_3bGlB",
	"name": "Game_name_2Qge_",
	"times": "Game_times_1idE8",
	"modal_overlay": "Game_modal_overlay_3GerV",
	"modal_container": "Game_modal_container_2dt9Z",
	"modal_content": "Game_modal_content_2setp",
	"join_next": "Game_join_next_rB8pE",
	"result_text": "Game_result_text_1vqrk"
};
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return getDataDetail; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return createLogger; });
...
/* harmony import */ var _ILogger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("7835");
/* harmony import */ var _Loggers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("7b74");
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
        ...
        if (logLevel >= this.minimumLogLevel) {
            switch (logLevel) {
                ...
                case _ILogger__WEBPACK_IMPORTED_MODULE_0__[/* LogLevel */ "a"].Error:
                    console.error("[" + new Date().toISOString() + "] " + _ILogger__WEBPACK_IMPORTED_MODULE_0__[/* LogLevel */ "a"][logLevel] + ": " + message);
                    break;
                case _ILogger__WEBPACK_IMPORTED_MODULE_0__[/* LogLevel */ "a"].Warning:
                    console.warn("[" + new Date().toISOString() + "] " + _ILogger__WEBPACK_IMPORTED_MODULE_0__[/* LogLevel */ "a"][logLevel] + ": " + message);
                    break;
                case _ILogger__WEBPACK_IMPORTED_MODULE_0__[/* LogLevel */ "a"].Information:
                    console.info("[" + new Date().toISOString() + "] " + _ILogger__WEBPACK_IMPORTED_MODULE_0__[/* LogLevel */ "a"][logLevel] + ": " + message);
                    break;
                default:
                    // console.debug only goes to attached debuggers in Node, so we use console.log for Trace and Debug
                    console.log("[" + new Date().toISOString() + "] " + _ILogger__WEBPACK_IMPORTED_MODULE_0__[/* LogLevel */ "a"][logLevel] + ": " + message);
                    break;
            }
        }
    };
...
/******/ });
//# sourceMappingURL=pk-game.js.map